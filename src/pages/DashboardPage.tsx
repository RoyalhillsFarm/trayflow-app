...
export default function DashboardPage() {
  ...
  return (
    <div className="page">
      ...
      >
        Dashboard restored. Task/account isolation still needs to be implemented in the data layer because the tasks table does not currently have an <strong>account_id</strong> column.
      </div>
